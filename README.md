...
#1. The sum of each Injury type was calculated and visualized showing that Fatal Injuries were the highest and most common type of injury
2. I plotted a bar chart of total injuries versus engine type and it suggested that the Turbojet engines are associated with the highest total injuries.
3. A bar chart of number of engines and total injuries also indicated that total injuries tend to increase with an increase in the number of engines.
